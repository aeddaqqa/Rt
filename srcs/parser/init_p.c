...
/*   Updated: 2021/02/23 19:18:51 by aeddaqqa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_rt						*init_rt(bool save)
{
	...
	new->intersection = malloc(sizeof(double (*)(t_object*, t_ray*)) * 4);
	new->normal = malloc(sizeof(t_vect3 (*)(t_object*, t_ray*, t_rt*, double)) * 4);
